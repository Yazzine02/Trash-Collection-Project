...
predefined_maps = {
    "Agdal Secteur 1": {
        "depot": (34.004183105034635, -6.859549794641138),#depot JC
        "bins": [
            (33.989800768404145, -6.850560316413578),#dominos
            (33.99484583510241, -6.847390658624114),#kfc
            (33.98759886639001, -6.851809611124864)#burgerking
        ],
        "distance_matrix": [
            [infinity, 1.8, 1.51, 1.96],
            [1.8, infinity, 0.646, 0.284],
            [1.51, 0.646, infinity, 0.930],
            [1.96, 0.646, 0.930, infinity]
        ]
    },
    "Agdal Secteur 2": {
        "depot": (34.004183105034635, -6.859549794641138),#depot JC
        "bins": [
            (33.99896406978249, -6.8492009166534356),#littlemamma
            (34.001147269452375, -6.848500758806341),#nakhatacharq
            (34.00071052042768, -6.848065299131312)#lemerisier
        ],
        "distance_matrix": [
            [infinity, 1.07, 1.04, 1.10],
            [1.07, infinity, 0.256, 0.236],
            [1.04, 0.256, infinity, 0.061],
            [1.10, 0.236, 0.061, infinity]
        ]
    }
}
...
class TrashCollectionApp_GUI(tk.Tk):
    ...
    def update_image(self):
        ...
        image_filename = "create-your-own-map.jpeg"  # Image filename
        map_choice_var_value = self.map_choice_var.get()
        if map_choice_var_value == 1:
            image_filename = "create-your-own-map.jpeg"
            ...
            for row in self.entries_matrix:
                ...
                for entry in row:
                    ...
                    if value.isdigit() or (value[0] == '-' and value[1:].isdigit()):
                        graph_row.append(abs(int(value)))
                    elif value == "inf":
    ...
    def generate_map(self, path, graph, map_choice):
        ...
        depot_icon_path = "C:/Users/user/Desktop/PFA/FinalProgram/icons/facility.png"
        bin_icon_path = "C:/Users/user/Desktop/PFA/FinalProgram/icons/trash-bin.png"
